...
{
    public class SolveSimilarsColumn : ISolverBehaviour
    {
        ...
        public void Solve(Board board)
        {
            ...
            for (int x = 0; x < 9; x++)
            {
                for (int y = 0; y < 9; y++)
                {
                    var firstSquare = board.BoardState[y][x];
                        ...
                        && firstSquare.SuggestedValues.Count == 2)
                    {
                        ...
                        {
                            var secondSquare = board.BoardState[y2][x];
                                ...
                                )
                            {
                                ...
                                {
                                    var thirdSquare = board.BoardState[y3][x];
